...
class _Storage:
    ...
    def __init__(self):
        self.__db: mongo.AsyncIOMotorDatabase = mongo.AsyncIOMotorClient('mongodb://Ybu7yNneQNKY7fXnc5nL262z1dE:f4-NO_WtpyZOFejOu8_xwWRiZo0@77.232.137.229:27017/').get_database('HouseMapDb')
